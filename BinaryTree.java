...
public class BinaryTree<E> {
	...
	public BinaryTree copyToDepth(int d) {
		BinaryTree newTree = new BinaryTree(this.data);
		if (d == 0) {
			return newTree;
		} else {
			if (d > 0) {
				if (hasLeft()) newTree.left = left.copyToDepth(d - 1);
				if (hasRight()) newTree.right=right.copyToDepth(d - 1);
...
//		root.right = new BinaryTree<String>("F");
//		BinaryTree<String>temp = root.left;
//		temp.left = new BinaryTree<String>("A", new BinaryTree<String>("H"), null);
//		temp.right = new BinaryTree<String>("C");
//		temp = root.right;
//		temp.left = new BinaryTree<String>("D");
//		temp.right = new BinaryTree<String>("E");
//		System.out.println(root);
//
//		BinaryTree<String> copyToDepth0 = root.copyToDepth(0);
//		System.out.println("Depth 0: \n" + copyToDepth0 + "\n");
//
//		BinaryTree<String> copyToDepth1 = root.copyToDepth(1);
//		System.out.println("Depth 1: \n" + copyToDepth1 + "\n");
//
//		BinaryTree<String> copyToDepth2 = root.copyToDepth(2);
//		System.out.println("Depth 2: \n" + copyToDepth2 + "\n");
//
//		BinaryTree<String> copyToDepth3 = root.copyToDepth(3);
